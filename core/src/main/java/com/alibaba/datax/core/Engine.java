...
public class Engine {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            //设置运行的datax的家目录
            System.setProperty("datax.home", "/Users/wenqi/MyGit/DataX/target/datax/datax");
            //设置datax的运行脚本信息
            args = new String[]{"-mode", "standalone", "-jobid", "-1", "-job", "/Users/wenqi/Documents/datax/job/mysql-mq2.json"};
            Engine.entry(args);
        } catch (Throwable e) {
            exitCode = 1;
